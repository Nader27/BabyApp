...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private EditText mregister_usernameView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mregister_usernameView = (EditText) findViewById(R.id.register_username);
    ...
    */
     ...
     *
     * @param show Send True To show progressbar and hide Login form
     *             Send False To hide progressbar and show Login form
     */
